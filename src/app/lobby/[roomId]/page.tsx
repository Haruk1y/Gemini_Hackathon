  ...
  return (
    <main className="page-enter mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-5 px-4 py-7 md:px-8">
      <Card className="space-y-5 bg-white p-6">
        <section className="rounded-lg border-2 border-[var(--pmb-ink)] bg-[var(--pmb-yellow)] p-4">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              {copyStatus === "done" ? (
                <p className="mt-1 text-xs font-semibold">コピーしました</p>
              ) : null}
              {copyStatus === "error" ? (
